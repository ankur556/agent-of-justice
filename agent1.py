...
class LawyerAgent(CourtAgent):
    def __init__(self, name, role):
        prompt = ("You are a prosecutor. Build your case through evidence and legal precedent."
                  if role == "Prosecutor" else
                  "You are a defense attorney. Identify weaknesses, present alternatives, establish doubt.")
